...
// One mapping for every recorder, so a combination captured here is the same
// combination when the user later opens Settings → Hotkeys.
export { mapBrowserKeyToEvdev } from "../keys";
