...
mod linux {
    ...
    #[interface(name = "ai.voxctl.Dictation")]
    ...
    pub async fn start_service(
        ...
        conn.object_server()
            .at("/ai/voxctl/Dictation", iface)
            .await?;
        conn.request_name("ai.voxctl.Dictation").await?;
        info!("DBus service registered: ai.voxctl.Dictation");
        Ok(conn)
    }
    ...
    pub async fn emit_status_changed(
        ...
        let iface_ref = conn
            .object_server()
            .interface::<_, DictationInterface>("/ai/voxctl/Dictation")
            .await?;
